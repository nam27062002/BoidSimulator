...
public class FishMovements : MonoBehaviour
{
    ...
    {
        List<FishMovements> fishesInRange = FishesInRange();
    ...
    private Vector2 Alignment(List<FishMovements> neighbors)
    {
    ...
    private Vector2 Cohesion(List<FishMovements> neighbors)
    {
        if (neighbors.Count == 0 || neighbors.Count > _fishMovementData.maxGroupSize)
            return Vector2.zero;
